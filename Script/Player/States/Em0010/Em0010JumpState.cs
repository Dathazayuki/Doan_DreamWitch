...
{
    public class Em0010JumpState : PlayerState
    {
        ...
        public Em0010JumpState(PlayerController controller) : base(controller)
        {
        ...
        public override void Update()
        {
            ...
            {
                isFalling = true;
                controller.AnimationController?.CrossFadeAnimation(PlayerAnimationEm0010States.FALL, 0.1f);
            }
        }
