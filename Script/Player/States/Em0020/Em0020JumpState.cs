...
{
    public class Em0020JumpState : PlayerState
    {
        ...
        public Em0020JumpState(PlayerController controller) : base(controller)
        {
        ...
        public override void Update()
        {
            ...
            if (!isFalling && movement.Velocity.y < -0.5f)
            {
                isFalling = true;
                controller.AnimationController?.CrossFadeAnimation(PlayerAnimationEm0020States.FALL, 0.1f);
            }
        }
