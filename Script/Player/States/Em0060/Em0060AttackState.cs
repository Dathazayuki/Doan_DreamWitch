...
{
    public class Em0060AttackState : PlayerState
    {
    ...
    private const float COMBO_QUEUE_START = 0.25f;
        ...
        public Em0060AttackState(PlayerController controller) : base(controller) {
        ...
        public override void Enter()
        {
            ...
            if (isUpAttack)
            {
                ...
                currentAnimation = PlayerAnimationEm0060States.ATK_UP_1;
            ...
            if (!isHeavyStrike)
            {
                if (input.AttackHeld)
                {
                    ...
                    if (heavyStrikeHoldTimer >= HEAVY_STRIKE_HOLD_DURATION)
                    {
                        ...
                        currentAnimation = PlayerAnimationEm0060States.ATK_HEAVY_STRIKE;
                        controller.AnimationController?.ForcePlayAnimation(currentAnimation);
                        attackTimer = 0f;
                        return;
                    }
        ...
        private void PlayComboStep(int step)
        {
            ...
            {
                case 2:
                    currentAnimation = PlayerAnimationEm0060States.ATK_2;
                    break;
                case 3:
                    currentAnimation = PlayerAnimationEm0060States.ATK_3;
                    break;
                default:
                    currentAnimation = PlayerAnimationEm0060States.ATK_1;
                    break;
            }
