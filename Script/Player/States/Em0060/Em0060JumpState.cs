...
{
    public class Em0060JumpState : PlayerState
    {
    ...
    private bool isLanding;
        ...
        public Em0060JumpState(PlayerController controller) : base(controller) {
        ...
        public override void Enter()
        {
            ...
            controller.AnimationController?.ForcePlayAnimation(jumpAnim);
        }
