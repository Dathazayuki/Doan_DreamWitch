...
Giải pháp tổng quan được triển khai thông qua dự án trò chơi "Dream Knight". Tựa game được phát triển dựa trên việc tích hợp toàn diện cấu trúc thế giới mở liên thông, hệ thống chiến đấu chặt chẽ và các cơ chế xây dựng nhân vật có chiều sâu. Điểm nổi bật về mặt kỹ thuật và cũng là đóng góp chính của đồ án bao gồm việc thiết kế thành công hệ thống nhập hồn Enemy, và đặc biệt là hệ thống quản lý hành vi kẻ địch dựa trên kiến trúc cây hành vi phức tạp (AI Behavior Tree). Kết quả sau cùng của đồ án là một sản phẩm trò chơi hoàn chỉnh, vận hành ổn định trên môi trường Unity, chứng minh tính khả thi của các giải pháp kỹ thuật đã đề xuất và mở ra hướng tối ưu hóa hiệu quả cho quy trình phát triển game độc lập.
