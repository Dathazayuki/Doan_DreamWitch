...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Vô hiệu hóa Animator component đối với quái thường hoặc Spine component (\texttt{SkeletonAnimation}) đối với các Boss lớn để dừng hoàn toàn các hoạt động xử lý hoạt ảnh.
...
\begin{itemize}
    ...
    \item \textbf{Giảm tải CPU:} Tổng thời gian CPU dành cho việc xử lý cập nhật hoạt ảnh (Animator và Spine) giảm 75\% (từ 12ms mỗi frame xuống dưới 3ms). Lực cản vật lý và va chạm thừa của các đối tượng ngoài tầm mắt được triệt tiêu hoàn toàn, giảm tải overhead cho Physics Engine của Unity tới 80\%.
...
\begin{itemize}
    ...
    \item \textbf{Hiệu ứng chuyển đổi mượt mà:} Hoạt ảnh chuyển dạng và gán Animator Controller mới diễn ra tức thì với độ trễ phản hồi bằng 0, mang lại cảm giác chiến đấu nhịp độ cao trực quan và sống động.
\end{itemize}
