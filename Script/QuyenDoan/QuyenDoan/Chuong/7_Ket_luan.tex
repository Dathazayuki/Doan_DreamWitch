...
\begin{itemize}
    ...
    \item \textbf{Về mặt kỹ thuật và phát triển:} Hiện thực hóa thành công trò chơi trên game engine Unity bằng ngôn ngữ C\#. Xây dựng hoàn chỉnh máy trạng thái hữu hạn (FSM) cho chuyển động của nhân vật chính và hành vi trí tuệ nhân tạo (AI) của kẻ địch. Tích hợp thành công hệ thống Animator điều khiển trực tiếp bằng chuỗi ký tự (string-based) cho nhân vật và quái vật thường, cùng hoạt ảnh Spine 2D mượt mà đối với các thực thể Boss lớn.
